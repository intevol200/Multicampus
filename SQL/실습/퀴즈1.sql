...
SELECT D.DEPTNO, D.DNAME, 
       NVL(SUM(DECODE(E.JOB, 'ANALYST', E.SAL)), 0) AS ANALYST,
       NVL(SUM(DECODE(E.JOB, 'CLERK', E.SAL)), 0) AS CLERK,
       NVL(SUM(DECODE(E.JOB, 'MANAGER', E.SAL)), 0) AS MANAGER,
       NVL(SUM(DECODE(E.JOB, 'PRESIDENT', E.SAL)), 0) AS PRESIDENT,
       NVL(SUM(DECODE(E.JOB, 'SALESMAN', E.SAL)), 0) AS SALESMAN
...
SELECT D.DEPTNO, D.DNAME, 
       SUM(CASE E.JOB WHEN 'ANALYST' THEN E.SAL END) AS ANALYST,
       SUM(CASE E.JOB WHEN 'CLERK' THEN E.SAL END) AS CLERK,
       SUM(CASE E.JOB WHEN 'MANAGER' THEN E.SAL END) AS MANAGER,
       SUM(CASE E.JOB WHEN 'PRESIDENT' THEN E.SAL END) AS PRESIDENT,
       SUM(CASE E.JOB WHEN 'SALESMAN' THEN E.SAL END) AS SALESMAN
FROM DEPT D LEFT JOIN EMP E
  ON D.DEPTNO = E.DEPTNO
GROUP BY D.DEPTNO, D.DNAME
ORDER BY 1;
